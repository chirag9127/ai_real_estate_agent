    ...
    def parse_json_fields(cls, data: Any) -> Any:
        if hasattr(data, "__dict__"):
            ...
            for field in [
                ...
                "min_full_baths", "min_total_baths", "min_total_parking",
                "min_garage_spaces", "garage_type",
                "basement_required", "basement_finished",
                "basement_separate_entrance", "basement_legal_suite",
                "city", "sub_area",
